...
\if@twoside
	...
	\fancyfoot[LE]{\setlength{\unitlength}{1mm}
		\begin{picture}(0,0)
		\put(0,-2){\includegraphics[height=0.6cm,width=0.6cm]{03_images/ITIVlogo.png}}
		\end{picture}
...
\if@twoside
	...
	\fancyhf{}
	\fancyfoot[LE]{\setlength{\unitlength}{1mm}
		\begin{picture}(0,0) \put(0,-2){\includegraphics[height=0.6cm,width=0.6cm]{03_images/ITIVlogo.png}} \end{picture}
		\put(9,2){\scriptsize\sf{\Institut}}\put(9,-2){\scriptsize\sf{\Dachorganisation}}}
	\cfoot{}
	\fancyfoot[RO]{\footnotesize\sf{\titelderarbeit}}
...
\else
	...
	\begin{picture}(0,0)
	\put(0,-2){\includegraphics[height=0.6cm,width=0.6cm]{03_images/ITIVlogo.png}}
	\end{picture}\put(9,2){\scriptsize\sf{\Institut}}\put(9,-2){\scriptsize\sf{\Dachorganisation}}}
	\cfoot{}
